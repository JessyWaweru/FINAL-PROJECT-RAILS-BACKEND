...
product21=Product.create(name: "Make-up Kit", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://i.pinimg.com/564x/d8/79/f9/d879f900e06077b32db7985922a6ec33.jpg",amazon_id:amazon21.id,kilimall_id:kilimall21.id,jumium_id:jumium21.id,shopify_id:shopify21.id)
product22=Product.create(name: "Atomic Habits", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon22.id,kilimall_id:kilimall22.id,jumium_id:jumium22.id,shopify_id:shopify22.id)
product23=Product.create(name: "Good News Bible", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon23.id,kilimall_id:kilimall23.id,jumium_id:jumium23.id,shopify_id:shopify23.id)
product24=Product.create(name: "Ceramic Cutlery", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon24.id,kilimall_id:kilimall24.id,jumium_id:jumium24.id,shopify_id:shopify24.id)
product25=Product.create(name: "Ladies Trenchcoat", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon25.id,kilimall_id:kilimall25.id,jumium_id:jumium25.id,shopify_id:shopify25.id)
product26=Product.create(name: "Dumbell", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon26.id,kilimall_id:kilimall26.id,jumium_id:jumium26.id,shopify_id:shopify26.id)
product27=Product.create(name: "Daily Journal", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon27.id,kilimall_id:kilimall27.id,jumium_id:jumium27.id,shopify_id:shopify27.id)
product28=Product.create(name: "Waterbottle", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon28.id,kilimall_id:kilimall28.id,jumium_id:jumium28.id,shopify_id:shopify28.id)
product29=Product.create(name: "Skateboard", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon29.id,kilimall_id:kilimall29.id,jumium_id:jumium29.id,shopify_id:shopify29.id)
product30=Product.create(name: "Keyboard", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon30.id,kilimall_id:kilimall30.id,jumium_id:jumium30.id,shopify_id:shopify30.id)
product31=Product.create(name: "Maybelline Mascara", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon31.id,kilimall_id:kilimall31.id,jumium_id:jumium31.id,shopify_id:shopify31.id)
product32=Product.create(name: "Electric Toothbrush", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon32.id,kilimall_id:kilimall32.id,jumium_id:jumium32.id,shopify_id:shopify32.id)
product33=Product.create(name: "Faux succulents", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon33.id,kilimall_id:kilimall33.id,jumium_id:jumium33.id,shopify_id:shopify33.id)
product34=Product.create(name: "Cerave Moisturizing FaceWash ", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon34.id,kilimall_id:kilimall34.id,jumium_id:jumium34.id,shopify_id:shopify34.id)
product35=Product.create(name: "Travel Mugs", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon35.id,kilimall_id:kilimall35.id,jumium_id:jumium35.id,shopify_id:shopify35.id)
product36=Product.create(name: "Mielle Organics Hair Oil", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon36.id,kilimall_id:kilimall36.id,jumium_id:jumium36.id,shopify_id:shopify36.id)
product37=Product.create(name: "Baby Wipes", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon37.id,kilimall_id:kilimall37.id,jumium_id:jumium37.id,shopify_id:shopify37.id)
product38=Product.create(name: "Bathroom Caddy", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon38.id,kilimall_id:kilimall38.id,jumium_id:jumium38.id,shopify_id:shopify38.id)
product39=Product.create(name: "Fidget Spinner", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon39.id,kilimall_id:kilimall39.id,jumium_id:jumium39.id,shopify_id:shopify39.id)
product40=Product.create(name: "Glass Vase", description: "900 Global Wolverine checkered Moss Bowling Ball-with pin", image: "https://images.unsplash.com/photo-1617895120763-edd71143f9bd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Ym93bGluZyUyMGJhbGx8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon40.id,kilimall_id:kilimall40.id,jumium_id:jumium40.id,shopify_id:shopify40.id)
