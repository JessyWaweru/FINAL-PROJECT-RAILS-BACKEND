...
product20=Product.create(name: "Bawling ball", description: "900 Global Wolverine Dark Moss Bowling Ball", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3-o-zSRc7fUI856cJFTNz1BqERasg78TxMw&usqp=CAU",amazon_id:amazon2.id,kilimall_id:kilimall2.id,jumium_id:jumium2.id,shopify_id:shopify2.id)
