...
product19=Product.create(name: "Champagne", description: "Cook's California Champagne Brut White Sparkling Wine - 750ml Bottle : Target", image: "https://images.unsplash.com/photo-1635674686943-01e7431e91c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fHdpbmUlMjBib3R0bGV8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60",amazon_id:amazon19.id,kilimall_id:kilimall19.id,jumium_id:jumium19.id,shopify_id:shopify19.id)
